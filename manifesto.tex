...
\lettrine[lines=3, lhang=0.1, nindent=0em, slope=-0.5em]{E}{ste} grupo nasce da convergência entre a tradição técnico-científica da Estatística e da 
...
Este manifesto estabelece os princípios que orientam nossas atividades, consolidando um compromisso coletivo com excelência técnico-científica, 
...
Defendemos que o conhecimento deve ser livremente acessível, auditável e reutilizável; promovemos práticas que favoreçam 
...
Toda análise deve ser passível de reprodução independente; priorizamos ambientes versionados, código documentado e \textit{pipelines} de análise de dados auditáveis
 como requisitos mínimos de rigor técnico-científico.
\end{principio}
