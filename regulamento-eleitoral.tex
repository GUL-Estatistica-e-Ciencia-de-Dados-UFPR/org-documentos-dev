...
\begin{conduta}
	...
	\begin{conduta}
		...
		\item Markdown (.md)
		\item HTML (.html)
	\item Assinados digitalmente via PGP pelo candidato a coordenador da chapa visando reconhecimento de autenticidade. O candidato a coordenador fica responsável por garantir a concordância dos demais membros da chapa.
	\end{conduta}
\end{conduta}
