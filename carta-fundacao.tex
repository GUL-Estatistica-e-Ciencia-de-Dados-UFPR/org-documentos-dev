...
Estatística e Ciência de Dados da Universidade Federal do Paraná (UFPR), constituído como uma iniciativa acadêmica, técnica e científica voltada à promoção do 
...
Este grupo emerge da convergência entre a necessidade contemporânea de rigor metodológico, reprodutibilidade e autonomia tecnológica, e a 
...
espaço de colaboração, formação técnica e produção técnico-científica, orientado por princípios formais expressos em seu Manifesto e regulado primariamente por seu Código de Conduta.

%--- Seção 2: Justificativa -------------------------------------------------
\section{Justificativa}

A Estatística e Ciência de Dados moderna depende intrinsecamente de ambientes computacionais complexos, frequentemente sustentados por \textit{software} livre e 
de código aberto. Sistemas operacionais baseados em Linux (e outros sistemas operacionais com liçencas de \textit{software} livre e código aberto) constituem a espinha dorsal de 
infraestruturas científicas, incluindo computação de alto desempenho, \textit{pipelines} de análise de dados, aprendizado de máquina e engenharia de dados.
...
práticas técnico-científicas alinhadas aos princípios do conhecimento aberto, visando formar profissionais capazes de operar, compreender e desenvolver 
...
Promover o uso, estudo e desenvolvimento de tecnologias baseadas em Linux, \textit{software} livre e código aberto no âmbito da Estatística e Ciência de Dados, 
fomentando a excelência técnica, a colaboração aberta e a produção técnica e científica reprodutível.

\subsection{Objetivos Específicos}

\begin{conduta}
  \item Incentivar a adoção de sistemas Linux e outros sistemas operacionais de código aberto como ambiente primário de desenvolvimento técnico-científico
  \item Promover o uso de ferramentas de \textit{software} livre e código aberto em análise de dados, engenharia de dados, modelagem estatística e aprendizado de máquina
  ...
  \item Fomentar práticas de reprodutibilidade técnico-científica e versionamento de experimentos
  \item Estabelecer conexões com a comunidade de \textit{software} livre e código aberto e com as comunidades acadêmico-científicas nacionais e internacionais
...
O grupo orienta-se pelos princípios estabelecidos em seu Manifesto, que define os valores centrais relacionados à ciência e tecnologia abertas, \textit{software} livre, 
...
Complementam o conjunto de documentos que estabelecem os Princípios Fundamentais do GULECD/UFPR o seu Regulamento Eleitoral, que define as regras e procedimentos para eleição 
periódica da coordenação, assim como a sua Política de Privacidade, que determina normas a serem seguidas em relação a coleta, armazenamento e uso dos dados de seus membros, 
participantes de projetos e demais pessoas que integrarem atividades do grupo.

Compete à gestão da Coordenação Fundadora o desenvolvimento, aprovação e publicação de um Regimento Interno que deverá ser composto em acordo com os princípios contidos 
...
explícita ou implicitamente, os termos desta Carta de Fundação e demais documentos fundacionais.
...
Poderão candidatar-se membros ativos do grupo, sendo desejado histórico de contribuição e obrigatoriamente comprometimento com os princípios estabelecidos 
no Manifesto e Código de Conduta.
...
-- A presente Carta de Fundação entra em vigor a partir de sua publicação e estabelece as bases institucionais, operacionais e éticas do Grupo de Usuários Linux e Software Livre do curso de Estatística e Ciência de Dados da UFPR, consolidando seu compromisso com a construção de uma comunidade técnico-científica de excelência, orientada pela liberdade, pelo rigor científico e pela colaboração aberta.

-- Esta Carta de Fundação constitui registro histórico do ato de criação do GULECD/UFPR, não estando sujeita a alterações após sua formalização.
